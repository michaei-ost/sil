...
thm AssignE
inductive_cases AssignNDE[elim!]: "(x ::= ND vals, s) \<Rightarrow> t"
thm AssignNDE
inductive_cases SeqE[elim!]: "(c1;;c2,s1) \<Rightarrow> s3"
thm SeqE
inductive_cases IfE[elim!]: "(IF b THEN c1 ELSE c2,s) \<Rightarrow> t"
thm IfE
inductive_cases SelectNDE[elim!]: "(SELECT bs, s) \<Rightarrow> t"
thm SelectNDE
...
theorem big_step_determ:
  shows "\<lbrakk> cs \<Rightarrow> t ;  cs \<Rightarrow> u ;  nd_free_cs cs\<rbrakk> \<Longrightarrow> u = t"
  thm big_step.induct
...
(*
theorem
  "\<lbrakk>cs  \<Rightarrow> t ;  cs \<Rightarrow> t' ; nd_free_cs cs\<rbrakk>  \<Longrightarrow>  t' = t"
